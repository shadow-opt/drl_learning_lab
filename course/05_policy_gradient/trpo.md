...
- Demo：`labs/05_policy_gradient/trpo/code/trpo_math_demo.py`
- 数学工具：`src/drl_lab/algorithms/trpo/math.py`
- 测试：`tests/test_trpo.py`
- PPO 对照：`course/05_policy_gradient/ppo.md`
- Spinning Up mapping：`labs/06_spinningup_track/trpo/spinningup_mapping.md`
...
在 `labs/05_policy_gradient/trpo/report.md` 中写出 TRPO 和 PPO 的关系。
