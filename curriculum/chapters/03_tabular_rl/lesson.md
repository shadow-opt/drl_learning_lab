...
- Value iteration demo：`curriculum/chapters/03_tabular_rl/code/value_iteration_demo.py`
- Policy iteration demo：`curriculum/chapters/03_tabular_rl/code/policy_iteration_demo.py`
- Monte Carlo demo：`curriculum/chapters/03_tabular_rl/code/monte_carlo_control_demo.py`
- TD control demo：`curriculum/chapters/03_tabular_rl/code/td_control_demo.py`
- Q-learning demo：`curriculum/chapters/03_tabular_rl/code/q_learning_demo.py`
...
```bash
conda run -n drl-lab python curriculum/chapters/03_tabular_rl/code/value_iteration_demo.py
conda run -n drl-lab python curriculum/chapters/03_tabular_rl/code/policy_iteration_demo.py
conda run -n drl-lab python curriculum/chapters/03_tabular_rl/code/monte_carlo_control_demo.py
conda run -n drl-lab python curriculum/chapters/03_tabular_rl/code/td_control_demo.py
