...
先读 `curriculum/chapters/05_policy_gradient/lesson.md`，再按顺序进入 VPG、PPO、TRPO、DDPG、TD3、SAC 子章节。
...
```bash
conda run -n drl-lab python curriculum/chapters/05_policy_gradient/code/list_algorithms.py
```

各算法 demo 在 `curriculum/chapters/05_policy_gradient/<algo>/code/`。
