...
- Demo：`curriculum/chapters/05_policy_gradient/vpg/code/vpg_core_demo.py`
...
在 `curriculum/chapters/05_policy_gradient/vpg/report.md` 中写出你对 `log_prob * advantage` 的解释。
...
- 能完成 `curriculum/chapters/05_policy_gradient/vpg/report.md`。
