...
- Demo：`curriculum/chapters/07_experiment_engineering/code/snapshot_demo.py`
...
检查 run 目录中是否存在 config、environment、metrics、checkpoint、ONNX。把发现写入 `curriculum/chapters/07_experiment_engineering/report.md`。
