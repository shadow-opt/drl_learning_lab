...
把 Spinning Up 当成“外部概念老师”，把 `curriculum/chapters/` 当成“中文重写和扩充”，把每章 `lab.md` 当成“作业”，把 `src/` 当成“工程参考”。每学一个算法，都要完成四个动作：
...
3. 打开 `curriculum/chapters/06_spinningup_track/<algo>/spinningup_mapping.md`。
4. 跑对应算法 demo。
...
- Mapping 列表：`curriculum/chapters/06_spinningup_track/code/list_mappings.py`
- Mapping 文件：`curriculum/chapters/06_spinningup_track/*/spinningup_mapping.md`
- Spinning Up 来源：`external/spinningup`
- VPG/PPO/TRPO/DDPG/TD3/SAC：`curriculum/chapters/05_policy_gradient`
...
```text
VPG  -> curriculum/chapters/05_policy_gradient/vpg/lesson.md  -> src/drl_lab/algorithms/vpg
PPO  -> curriculum/chapters/05_policy_gradient/ppo/lesson.md  -> src/drl_lab/algorithms/ppo
TRPO -> curriculum/chapters/05_policy_gradient/trpo/lesson.md -> src/drl_lab/algorithms/trpo
DDPG -> curriculum/chapters/05_policy_gradient/ddpg/lesson.md -> src/drl_lab/algorithms/ddpg
TD3  -> curriculum/chapters/05_policy_gradient/td3/lesson.md  -> src/drl_lab/algorithms/td3
SAC  -> curriculum/chapters/05_policy_gradient/sac/lesson.md  -> src/drl_lab/algorithms/sac
```

## 实验任务

```bash
conda run -n drl-lab python curriculum/chapters/06_spinningup_track/code/list_mappings.py
```

选择一个算法，例如 PPO，完成：

- 读 `curriculum/chapters/05_policy_gradient/ppo/lesson.md`；
- 读 Spinning Up PPO；
- 打开 `curriculum/chapters/06_spinningup_track/ppo/spinningup_mapping.md`；
- 跑 `curriculum/chapters/05_policy_gradient/ppo/code/ppo_core_demo.py`；
- 在 `curriculum/chapters/06_spinningup_track/report.md` 写出差异。
